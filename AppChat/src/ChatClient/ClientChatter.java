...
public class ClientChatter extends JFrame {
	...
	private final JTextField txtStaff = new JTextField();
	...
	public ClientChatter() {
		...
		panel.setBorder(new TitledBorder(null, "Staff and servser info.", TitledBorder.LEADING, TitledBorder.TOP, null, null));
